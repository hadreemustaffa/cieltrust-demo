        ...
        >
          ...
          <div className="flex flex-col gap-4 rounded-md border border-accent/10 p-4 text-left">
            ...
            <p>
              ...
              assistance, our customer support team is available to guide you.
            </p>
          </div>
          <div className="flex flex-col gap-4 rounded-md border border-accent/10 p-4 text-left">
            <h3 className="text-lg font-medium">
          ...
          <div className="flex flex-col gap-4 rounded-md border border-accent/10 p-4 text-left">
            ...
            <p>
              ...
              Password&quot; link on the login page. You will be prompted to
              enter your registered email address or phone number. Follow the
              instructions sent to your contact method to reset your password
              securely. If you encounter any issues, our customer support team
          ...
          <div className="flex flex-col gap-4 rounded-md border border-accent/10 p-4 text-left">
            ...
            <p>
              To dispute a transaction, log in to your online banking account
              and navigate to the &quot;Disputes&quot; section. Select the
              transaction you wish to dispute and provide the required details.
              You can also contact our customer support team directly for
              assistance. We will investigate the matter and keep you updated on
