...
export default function FaqSection() {
  ...
  return (
    <div className="flex flex-col items-center gap-8">
      <div
        className={`${isExpanded ? "max-h-full" : "max-h-[500px] border-b border-b-accent/20"} flex flex-col gap-4 overflow-y-hidden`}
      >
        ...
        <div className="flex flex-col gap-4 rounded-md border border-accent/10 p-4 text-left">
          ...
          <p>
            ...
            your registered email address or phone number. Follow the
            instructions sent to your contact method to reset your password
            securely. If you encounter any issues, our customer support team is
        ...
        <div className="flex flex-col gap-4 rounded-md border border-accent/10 p-4 text-left">
          ...
          <p>
            To dispute a transaction, log in to your online banking account and
            navigate to the &quot;Disputes&quot; section. Select the transaction
            you wish to dispute and provide the required details. You can also
            contact our customer support team directly for assistance. We will
            investigate the matter and keep you updated on the status of your
            dispute.
          </p>
        </div>
      </div>
      ...
      <ButtonSecondary onClick={handleExpand}>
        ...
        >
          <path
            d="M16.5 8.75L11 14.25L5.5 8.75"
            stroke="currentColor"
            strokeWidth="2"
          />
        </svg>
